...
public final class VideoMostViewed {
    /**
     * Am parcurs istoricul de vizionari al fiecarui utilizator in parte
     * si astfel am calculat numarul total de vizionari pentru fiecare videoclip
     * in parte. In felul acesta am putut face sortarea crescatoare sau descrescatoare,
     * afisand doar primii N dintre acestia (care nu au numarul de vizionari egal cu 0)
     *
    ...
    public void solve(final ActionInputData action, final Database mydatabase,
        ...
        if (action.getObjectType().equals("movies")) {
            ...
            movies.sort(new Comparator<MovieInputData>() {
                ...
                public int compare(final MovieInputData o1, final MovieInputData o2) {
                    if (action.getSortType().equals("asc")) {
                        Integer a = o1.getViews();
                        Integer b = o2.getViews();
                        if (a.compareTo(b) == 0) {
            ...
            for (int i = 0; i < movies.size() && takingVideos > 0; ++i) {
                ...
                if (movies.get(i).getViews().equals(0)) {
                    ok = 0;
                }
                if (ok == 1) {
            ...
            for (int i = 0; i < serials.size() && takingVideos > 0; ++i) {
                ...
                if (serials.get(i).getViews().equals(0)) {
                    ok = 0;
                }
                if (ok == 1) {
